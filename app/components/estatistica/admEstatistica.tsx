...
// // Tipagem para os dados estruturados da API do Admin
// interface DadosPeriodo {
//   total: number;
//   crescimentoSemanal: number; // Porcentagem de aumento comparado à semana anterior
// }
...
//   // Componente interno auxiliar para renderizar a badge de crescimento semanal
...
//           </div>
//           <div>
//             <span className="block text-3xl font-extrabold text-[#4F442E]">{dados?.usuarios.total.toLocaleString()}</span>
//             <span className="text-gray-400 text-xs font-semibold uppercase tracking-wider block mt-0.5">Usuários Totais</span>
//           </div>
//         </div>

//         {/* Card: Novas Postagens */}
//         <div className="bg-white border border-[#E8D89A] rounded-xl p-5 shadow-sm space-y-3">
//           <div className="flex justify-between items-center">
//             <div className="p-2 bg-amber-50 rounded-lg text-[#8A7A5B]">
//               <FileText size={20} />
//             </div>
//             <BadgeCrescimento valor={dados?.postagens.crescimentoSemanal || 0} />
//           </div>
//           <div>
//             <span className="block text-3xl font-extrabold text-[#4F442E]">{dados?.postagens.total.toLocaleString()}</span>
...
//           </div>
//           <div>
//             <span className="block text-3xl font-extrabold text-[#4F442E]">{dados?.comentarios.total.toLocaleString()}</span>
...
//           </div>
//           <div>
//             <span className="block text-3xl font-extrabold text-[#4F442E]">{dados?.curtidas.total.toLocaleString()}</span>
